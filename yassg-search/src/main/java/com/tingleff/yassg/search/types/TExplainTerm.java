...
public class TExplainTerm implements org.apache.thrift.TBase<TExplainTerm, TExplainTerm._Fields>, java.io.Serializable, Cloneable, Comparable<TExplainTerm> {
  ...
  static {
    schemes.put(StandardScheme.class, new TExplainTermStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TExplainTermTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.FIELD,_Fields.VALUE,_Fields.SCORE};
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TExplainTerm(");
    boolean first = true;
  ...
  private static class TExplainTermStandardSchemeFactory implements SchemeFactory {
    public TExplainTermStandardScheme getScheme() {
      return new TExplainTermStandardScheme();
    }
  }

  private static class TExplainTermStandardScheme extends StandardScheme<TExplainTerm> {
  ...
  private static class TExplainTermTupleSchemeFactory implements SchemeFactory {
    public TExplainTermTupleScheme getScheme() {
      return new TExplainTermTupleScheme();
    }
  }

  private static class TExplainTermTupleScheme extends TupleScheme<TExplainTerm> {
